...
// 包含通用工具， 包括move, forward, swap, pair等
#include <cstddef>
#include <iostream>
...
struct pair
{
  ...
  template <class Other1 = Ty1, class Other2 = Ty2,
    ...
    std::is_default_constructible<Other2>::value, void
    >::type
  ...
  template <class U1 = Ty1, class U2 = Ty2,
    ...
    std::is_convertible<const U2&, Ty2>::value, int
    >::type = 0
  ...
  // implicit construction for other type
